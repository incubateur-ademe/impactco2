...
test('Iframes', async ({ page }) => {
  ...
  await page.goto(
    'http://localhost:3000/iframes/comparateur/etiquette-animee?value=4.403191585&comparisons=abricot,ail,tomate'
  )
  ...
  await page.goto(
    'http://localhost:3000/iframes/comparateur/etiquette?value=4.403191585&comparisons=abricot,ail,tomate'
  )
  await expect(page.getByTestId('etiquette-value')).toContainText('4.4')
  await expect(page.getByTestId('etiquette-abricot-value')).toContainText('5')
  await expect(page.getByTestId('etiquette-ail-value')).toContainText('12.3')
