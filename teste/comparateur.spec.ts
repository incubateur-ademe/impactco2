...
test('Iframes', async ({ page }) => {
  ...
  await expect(page.getByTestId('comparateur-voitureelectrique+3-value')).toHaveText('431')
  ...
  await expect(page.getByTestId('etiquette-voitureelectrique+3-value')).toHaveText('431')
