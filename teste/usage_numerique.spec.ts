...
test('Load default values', async ({ page }) => {
  ...
  await expect(page.getByTestId('usagenumerique-generated-value')).toHaveText('2.06')
  await expect(page.getByTestId('category-email')).toHaveText("1 an d'email - 38688 emails44.4 kg CO₂e")
