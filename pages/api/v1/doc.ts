...
const config = {
  definition: {
    ...
    info: {
      ...
      <br />
      L'api Impact CO<sub>2</sub> vous permet d'automatiser le calcul de l'impact carbone. Si vous avez des idées d'améliorations ou des requêtes plus spécifiques, n'hesitez pas à nous contacter via [${process.env.CONTACT_EMAIL}](mailto:${process.env.CONTACT_EMAIL}).
      <br />
