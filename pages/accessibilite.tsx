      ...
      <Section>
        <SectionWideContent>
          <FormatText>
            ...
            <p>
              La présente déclaration d’accessibilité s’applique au site impact CO₂ ({process.env.NEXT_PUBLIC_URL}) dont
            ...
            <p>
              Le site Impact CO₂ est non conforme avec le Référentiel général d’amélioration de l’accessibilité, RGAA
