  ...
  test('get default values', async () => {
    ...
    expect(data).toEqual({
      data: [
        ...
        { ecv: 151.81056915609627, name: 'Chaudière électrique', slug: 'chauffageelectrique' },
  ...
  test('get values in english', async () => {
    ...
    expect(data).toEqual({
      data: [
        ...
        { ecv: 151.81056915609627, name: 'Electric boiler', slug: 'chauffageelectrique' },
  ...
  test('get specific surface', async () => {
    ...
    expect(data).toEqual({
      data: [
        ...
        { ecv: 240.969157390629, name: 'Chaudière électrique', slug: 'chauffageelectrique' },
