      ...
      axios.get(`https://deploy-preview-1895--ecolab-data.netlify.app/co2-model.FR-lang.fr.json`).then((res) => {
        ...
        let obj = {
          ...
          "livraison colis . empreinte production mix électrique chine": {
            formule: 871.2,
            unité: "gCO2e / kWh",
            note: "FE issus de l'IEA, correspond à priori au FE de production de mix électrique (issu de l'étude \"usage numérique\")\nPour l'Europe, on est à 410.4 gCO2e/kWh\n",
          },
          ...
          "livraison colis . déplacement consommateur . mode de déplacement": {
            avec: {
              "voiture thermique": null,
              "voiture hybride": null,
              "voiture électrique": null,
            },
            formule: {
              "une possibilité": {
          ...
          "livraison colis . déplacement consommateur . commun . usage . empreinte": {
            formule: 113,
            unité: "gCO2e/km",
            note: "Base carbone: Autobus/Gazole: 113 gCO2e/km\n",
          },
          ...
          "livraison colis . déplacement consommateur . petit véhicule électrique . usage . empreinte": {
            formule: 10.9,
            unité: "gCO2e/km",
            note: "Base carbone: Vélo/à assistance électrique: 10.9 gCO2e/km\n",
          },
          ...
          "livraison colis . empreinte entrepot . volume de stockage par m2": {
            formule: 2,
            unité: "m3",
            note: "Hypothèse: Surface au sol = 1m2, hauteur étagère = 2m, largeur couloir = 0.4m\n",
          },
          "livraison colis . empreinte entrepot . nombre de colis par m2": {
            formule:
              "volume de stockage par m2 * 1000000 cm3 / (informations . volume * facteur multiplication volume)",
            unité: "colis / m2",
          ...
          "livraison colis . empreinte entrepot . facteur multiplication volume": {
            ...
            formule: 4,
            note: "Hypothèse: Un article occupe environ 4 fois son propre volume en entrepôt logistique (OEFSR retail 2018)\n",
          },
          ...
          "livraison colis par avion": {
            formule: {
              somme: ["entrepot stockage chine", "transport inter plateformes chine", "livraison colis"],
            },
          },
          "livraison colis par avion . entrepot stockage chine": {
            ...
            note: "L'idée ici est d'approcher l'impact de l'entrpôt en Chine via le mix électrique. Attention, c'est un mix de consommation.\nIl faudrait également faire ce travail pour la consommation de gaz.\n",
          },
          ...
          "livraison colis . scénario": {
            ...
            formule: {
              "une possibilité": {
                "choix obligatoire": "oui",
                possibilités: ["domicile", "point de retrait", "click and collect", "magasin traditionnel"],
              },
            },
            "par défaut": "'domicile'",
            description:
          ...
          "livraison colis . informations . catégorie": {
            ...
            formule: {
              "une possibilité": {
                "choix obligatoire": "oui",
                possibilités: ["grande consommation", "habillement", "culturel", "équipements volumineux", "autre"],
              },
            },
          ...
          "livraison colis . magasin . type": {
            ...
            formule: {
              "une possibilité": {
                "choix obligatoire": "oui",
                possibilités: ["hypermarché", "supermarché", "galerie marchande", "magasin spécialisé"],
              },
            },
          ...
          "livraison colis . magasin . volume stockage total": {
            ...
            unité: "m3",
            note: "Hypothèse: 50% du magasin est occupé par des étagères de 2m de hauteur\n",
          },
          ...
          "livraison colis . transport inter plateformes . empreinte trajet longue distance": {
            formule: {
              moyenne: ["aérien", "ferroviaire", "maritime"],
            },
            note: "On considère une moyenne de 3 modes de transport pour le cas de la Chine.\n\n![](https://fr.sino-shipping.com/wp-content/uploads/2021/07/fret-ferroviaire-chine-europe.jpg)\n",
          },
