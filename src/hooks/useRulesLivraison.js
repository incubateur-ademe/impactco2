...
const getData = () => {
  ...
  return {
    ...
    "livraison colis . empreinte entrepot . nombre de colis par m2": {
      formule: "volume de stockage par m2 * 1000000 cm3 / (informations . volume * 4)",
      unité: "colis / m2",
    ...
    "livraison colis . scénario . magasin traditionnel . déplacement consommateur": {
      formule: {
        recalcul: {
          ...
          avec: {
            "livraison colis . déplacement consommateur . mode de déplacement": "'voiture'",
    ...
    "livraison colis . transport inter plateformes . nombre": {
      titre: "Nombre de trajets entre plateformes dans le processus de livraison",
