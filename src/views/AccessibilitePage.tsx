...
const AccessibilitePage = () => {
  return (
    <div className={classNames(styles.container, 'main-container')}>
      ...
      <p>
        Le site Impact CO₂ est non conforme avec le Référentiel général d’amélioration de l’accessibilité, RGAA version
        4.1, car il n’existe aucun résultat d’audit en cours de validité permettant de mesurer le respect de ces
        critères.
      </p>
      ...
      <h2 id='établissement-de-cette-déclaration-daccessibilité'>Établissement de cette déclaration d’accessibilité</h2>
      ...
      <ul>
        <li>
          Les tests des pages webBlue ont été effectués avec les combinaisons de navigateurs webBlue et lecteurs d’écran
          suivants : Néant
        </li>
