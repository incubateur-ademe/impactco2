...
const MentionsLegalesPage = () => {
  return (
    <div className={classNames(styles.container, 'main-container')}>
      ...
      Il est précisé aux utilisateurs du site l'identité des différents intervenants dans le cadre de sa réalisation et
      de son suivi.
      ...
      dans l’économie numérique, le site <Link href='https://impactco2.fr'>https://impactco2.fr</Link> (et autres sites
      en ademe.fr, ci-après les “Sites”) est édité par l’ADEME, ayant son siège social au :
      <br />
      <br />
      ...
      Le prestataire assurant le stockage direct du site <Link href='https://impactco2.fr'>
        https://impactco2.fr
      </Link>{' '}
      ...
      les utilisateurs des Sites de l’ADEME sont donc invités à les consulter de manière régulière.
      <br />
      <br />
      ...
      l’ADEME, les actions mises en œuvre au sein des territoires, l’action internationale de l’ADEME, les programmes de
      ...
      <br />
      <br />
      Toutefois, elle ne pourra être tenue responsable des omissions, des inexactitudes des carences dans la mise à jour
      ou de tout autres manquements qu’ils soient de son fait ou du fait des tiers partenaires qui lui fournissent ces
      informations.
      <br />
      <br />
      ...
      d’un événement hors du contrôle de l’ADEME, et sous réserve des éventuelles pannes et interventions de maintenance
      ...
      <br />
      <br />
      La responsabilité de l’ADEME ne saurait être engagée en cas d’impossibilité d’accès à ce site et/ou d’utilisation
      des services.
      <br />
      <br />
      L’ADEME peut être amenée à interrompre le site ou une partie des services, à tout moment sans préavis, le tout
      sans droit à indemnités. L’utilisateur reconnaît et accepte que l’ADEME ne soit pas responsable des interruptions,
      ...
      polémique, pornographique, xénophobe ou pouvant, dans une plus large mesure, porter atteinte à la sensibilité du
      plus grand nombre.
      ...
      <Link href='https://github.com/incubateur-ademe/impactco2'>
        https://github.com/incubateur-ademe/impactco2
      </Link>{' '}
      ...
      condition de respecter l’intégrité des informations et de n’en altérer ni le sens, ni la portée, ni l’application
      et de faire mention du nom de l’ADEME ou d’en préciser l’origine et la date de publication avec la mention du
      crédit photo si tel est le cas.
      <br />
      <br />
      L’ADEME pourra autoriser la réutilisation d’informations à des fins commerciales ou promotionnelles par le biais
      d’une licence de réutilisation de ses informations. Est considérée comme réutilisation à des fins commerciales ou
      promotionnelles, l’élaboration à partir des informations publiques, d’un produit ou d’un service destiné à être
      mis à disposition de tiers, à titre gratuit ou onéreux.
      ...
      <br />
      <br />
      L’ADEME est attachée au respect des règles de protection de la vie privée des utilisateurs de son site internet et
      de ses services. L’ensemble des traitements de données personnelles mis en œuvre dans le cadre des services
      accessibles respecte la réglementation applicable en matière de protection des données personnelles et notamment
      les dispositions de la loi « Informatique et libertés » du 6 janvier 1978 modifiée et le Règlement général sur la
      ...
      merci de nous en <Link href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL}`}>faire part</Link>. Si vous
      ...
      recommandons d’utiliser la voie postale. L’ADEME dégage toute responsabilité quant aux difficultés techniques que
      vous pourriez rencontrer sur les Sites qu’elles qu’en soient la cause et l’origine.
