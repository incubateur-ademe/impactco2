...
export default function Learning(props) {
  ...
  const repas = (
    <>
      ...
      <Strong>
        Le quart des émissions de gaz à effet de serre en France provient de nos assiettes, c’est autant que le logement
        ou le transport&nbsp;!
      </Strong>
      <Text>
        ...
        ). Il est donc préférable de manger des produits d'origine végétale pour protéger l’écosystème de la planète.
      </Text>
    </>
  )
  ...
  const numerique = (
    <>
      <Title>Quel est l’impact sur le climat des appareils numériques&nbsp;?</Title>
      <Strong>
        L’empreinte carbone du secteur du numérique représente aujourd’hui 3 à 4% des émissions de gaz à effet de serre
        dans le monde et 2% de l’empreinte carbone à l’échelle nationale.
      </Strong>
      <Text>
        La grande majorité de l'impact du numérique provient de la fabrication des smartphones, ordinateurs, et tous les
        dispositifs que nous achetons. Pour limiter l'impact du numérique, il est donc primordial de garder le plus
        longtemps possible nos équipements et de privilégier les appareils reconditionnés : tous les métaux et matériaux
        utilisés pour la fabrication repartent ainsi pour une nouvelle vie.
      </Text>
    </>
  )
  ...
  const mobilier = (
    <>
      ...
      <Text>
        L'impact carbone d'un meuble comprenant la fabrication, la distribution et l’usage, peut aller de 19&thinsp;kg
        d’émissions de{' '}
        <ButtonLink onClick={() => setCo2e(true)}>
          CO<sub>2</sub>e
        </ButtonLink>{' '}
  ...
  const habillement = (
    <>
      ...
      <Text>
        L’impact carbone d’ un habit comprenant la fabrication, la distribution et l’usage, peut aller de 6&thinsp;kg
        d’émissions de{' '}
        <ButtonLink onClick={() => setCo2e(true)}>
          CO<sub>2</sub>e
        </ButtonLink>{' '}
  ...
  const electromenager = (
    <>
      <Title>Quel est l'impact sur le climat d'un appareil électroménager&nbsp;?</Title>
      <Text>
  ...
  const chauffage = (
    <>
      <Title>Quel est l’impact sur le climat du chauffage d'un logement&nbsp;?</Title>
      <Text>
  ...
  const boisson = (
    <>
      ...
      <Text>
        ...
        avec l’eau du robinet, comprenant l'impact de toute la gestion du réseau d'eau potable, jusqu’à 1,5&thinsp;kg
        d’émissions de{' '}
        <ButtonLink onClick={() => setCo2e(true)}>
          CO<sub>2</sub>e
        </ButtonLink>{' '}
  ...
  const usagenumerique = (
    <>
      <Title>Quel est l’impact sur le climat des usages numériques du quotidien&nbsp;?</Title>
      <Strong>
        L’empreinte carbone du secteur du numérique représente aujourd’hui 3 à 4% des émissions de gaz à effet de serre
        dans le monde et 2% de l’empreinte carbone à l’échelle nationale.
      </Strong>
      <Text>
        La grande majorité de l'impact du numérique provient de la fabrication des smartphones, ordinateurs, et tous les
        dispositifs que nous achetons. L'impact carbone des mails va grandement varié selon la taille des pièces jointes
        et le nombre de destinataires, quand l'impact du streaming ou d'une visioconférence va varier selon la qualité
        de l'image. Enfin, la vidéo via 4G peut être jusqu'à 2 fois plus émétrice qu'avec une connexion Wifi.
      </Text>
    </>
  )
  ...
  const fruitsetlegumes = (
    <>
      <Title>Quel est l’impact sur le climat des fruits et légumes&nbsp;?</Title>
      <Strong>
