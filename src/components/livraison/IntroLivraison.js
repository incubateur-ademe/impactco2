  ...
  return (
    <>
      ...
      <RegularParagraph data-testid='paragraph1'>
        <strong>80 % des Français</strong> de 11 ans et plus font des achats en
        ligne.
      </RegularParagraph>
      <RegularParagraph>
        En moyenne, cela représente <strong>1 milliard de colis par an</strong>,
        soit <strong>deux colis par personne par mois</strong>.
      </RegularParagraph>
      <Separator />
    </>
  )
