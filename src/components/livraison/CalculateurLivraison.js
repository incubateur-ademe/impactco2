        ...
        <ScreenshotWrapper2 innerRef={ref} isScreenshotting={isScreenshotting}>
          <Flex>
            ...
            <div className='buttons'>
              ...
              <Button size='sm' onClick={takeScreenshot} className='noscreenshot' aria-label='Télécharger'>
                ...
                <div className='item3'>
                  <Addendum>
                    ...
                    <span className='txt' data-testid='bcTrajet'>
                      {convertGramsToKilograms(diffs.diffKm0)} kg de CO₂e
                    </span>
                  </Addendum>
                </div>
              </FlexHabit>
                ...
                <div className='item3'>
                  <Addendum>
                    ...
                    <span className='txt' data-testid='bcAvion'>
                      {convertGramsToKilograms(diffs.diffPlane)} kg de CO₂e
                    </span>
                  </Addendum>
                </div>
              </FlexHabitBottom>
