  ...
  return (
    <Modal2 open={open} setOpen={setOpen} getTitle={getTitle} width={"80em"}>
      ...
      <p>
        ...
        en ligne, emballage, entrepôt de stockage, plateformes de tri, transport inter-platerformes, infrastruture de
        ...
        supplémentaire (9000km parcourus par avion, mix électrique de l'entrepôt de départ adapté). Nous ne prenons pas
        en compte les trainées de condensation pour l’aérien.
      </p>
      ...
      <p>
        Pour les étapes de <b>stockage</b> en entrepôt, on considère un entrepôt de <b>10 000 m2</b>. Le nombre de jour
        de stockage dépend du type de produit.
      </p>
      <p>
        En ce qui concerne les <b>camions de livraison</b>, pour le <b>transport longue distance</b>, nous avons
        considéré un
        <b>poids lourd moyen</b> (type 44 tonnes) tandis que pour les <b>derniers kilomètres</b> de livraison, nous
        avons considéré un
        <b>véhicule utilisaire léger</b>.{" "}
      </p>
