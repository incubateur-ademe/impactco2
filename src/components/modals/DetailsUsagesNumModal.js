  ...
  return (
    <Modal open={open} setOpen={setOpen}>
      ...
      <p>
        ...
        visioconférence. Les qualités "audio", "basse définition", "haute définition" correspondent respectivement à des
        tailles de vidéos de 164&thinsp;Mo, 700&thinsp;Mo et 3&thinsp;Go par heure. Concernant la transmission des
