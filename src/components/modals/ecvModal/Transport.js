  ...
  return (
    <>
      ...
      <p>
        ...
        fabrication de tout mode de transport, leur extraction, mise en forme et
        assemblage pour construire les modes de transport. Ces différentes
        étapes nécessitent notamment des engins et des machines et de l’énergie
        pour les faire fonctionner.
      </p>
      <h3>Carburant</h3>
      <p>
        Emissions directes liées à la combustion pour les moteurs thermiques,
        ainsi que tout au long du cycle de production et distribution de
        carburant. Pour l'électricité, émissions liées à la production et la
        distribution de l'électricité jusqu'au véhicule.
      </p>
