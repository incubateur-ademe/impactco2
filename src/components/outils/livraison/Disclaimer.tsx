...
const Disclaimer = ({ animated, id, className }: { animated?: boolean; id: string; className?: string }) => {
  return (
      ...
      <div className={styles.content}>
        {animated ? (
          ...
          <div>
            ...
            <br />
            <p>
              Les résultats présentés sont basés sur la livraison d’un colis de <b>1kg</b>, commandé en{' '}
              <b>54 minutes</b> et emballé dans <b>un carton de 468g</b>.
            </p>
            <br />
            <p>
            ...
            <ul>
              <li>
                ...
                magasin est fixée à 15 km en voiture.
              </li>
              <li>
