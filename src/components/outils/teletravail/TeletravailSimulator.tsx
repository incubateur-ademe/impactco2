...
import { getRandomEquivalentForValue } from 'src/components/comparateur/randomEtiquette.config'
import itineraireStyles from '../transport/ItineraireSimulator.module.css'
